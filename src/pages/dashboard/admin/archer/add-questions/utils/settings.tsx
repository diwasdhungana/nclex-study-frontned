...
import { SelectOne } from '@/pages/dashboard/admin/archer/add-questions/question-categories/selectOne';
import { MatrixNGrid } from '@/pages/dashboard/admin/archer/add-questions/question-categories/matrixNGrid';
import { Highlight } from '@/pages/dashboard/admin/archer/add-questions/question-categories/highlight';
import { ExtDropDown } from '@/pages/dashboard/admin/archer/add-questions/question-categories/extDropDown';
import { DragNDrop } from '@/pages/dashboard/admin/archer/add-questions/question-categories/dragNdrop';
import { BowTie } from '@/pages/dashboard/admin/archer/add-questions/question-categories/bowTie';
import { Mcq } from '@/pages/dashboard/admin/archer/add-questions/question-categories/mcq';
import { FillBlanks } from '@/pages/dashboard/admin/archer/add-questions/question-categories/fillBlanks';
