      ...
      <Group gap="xl" justify="space-between" mt="3px" mb="0px">
        ...
        <Group>
          <Button
            ...
            onClick={() => {
              navigate(
                `/dashboard/student/view-results/test?testId=${testId}&i=${prevIndex}&t=${totalQuestions}`
              );
            }}
          >
            Previous
          ...
          <Button
            ...
            onClick={() => {
              navigate(
                `/dashboard/student/view-results/test?testId=${testId}&i=${nextIndex}&t=${totalQuestions}`
              );
            }}
          >
            Next
